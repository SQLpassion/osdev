...
echo "------------------------------------"
"$SCRIPT_DIR/helper_build_user_programs.sh" release
echo ""
...
qemu-system-x86_64 \
    ...
    -netdev user,id=net0,net=192.168.1.0/24,dhcpstart=192.168.1.15,host=192.168.1.1,dns=192.168.1.3 -device rtl8139,netdev=net0 \
    "${QEMU_DISPLAY[@]}" \
    -m 256M \
    "$@"
