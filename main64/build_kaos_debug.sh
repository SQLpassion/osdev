...
echo "  -> Rust kernel built: kernel/target/x86_64-unknown-none/debug/kernel.bin"
...
echo "  -> Rust kernel loader built: kaosldr_64/target/x86_64-unknown-none/debug/kldr64.bin"
...
fat_imgen -m -f kaos64.img -i kaosldr_64/target/x86_64-unknown-none/debug/kldr64.bin
fat_imgen -m -f kaos64.img -i kernel/target/x86_64-unknown-none/debug/kernel.bin
...
echo "  - main64/kernel/target/x86_64-unknown-none/debug/kernel.bin"
echo ""
echo "To run in QEMU:"
