...
use super::types::{
    ...
    EXCEPTION_INVALID_OPCODE, IRQ0_PIT_TIMER_VECTOR, IRQ1_KEYBOARD_VECTOR, IRQ2_PIC_CASCADE_VECTOR,
    IRQ3_COM2_VECTOR, IRQ4_COM1_VECTOR, IRQ5_LPT2_OR_SOUND_VECTOR, IRQ6_FLOPPY_VECTOR,
    IRQ7_LPT1_OR_SPURIOUS_VECTOR, IRQ8_CMOS_RTC_VECTOR, IRQ9_ACPI_OR_LEGACY_VECTOR,
    IRQ10_FREE_VECTOR, IRQ11_FREE_VECTOR, IRQ12_PS2_MOUSE_VECTOR, IRQ13_FPU_VECTOR,
    IRQ14_PRIMARY_ATA_VECTOR, IRQ15_SECONDARY_ATA_VECTOR,
};
...
int80_syscall_stub:
    ...
    // explicit cli before iretq is required.
    sti
