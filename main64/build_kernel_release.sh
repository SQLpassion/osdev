...
echo "  -> Rust kernel loader built: kaosldr_64_rust/target/x86_64-unknown-none/release/kldr64.bin"
...
fat_imgen -m -f kaos64_rust.img -i kaosldr_64_rust/target/x86_64-unknown-none/release/kldr64.bin
